...
#               "has-a" relationship
# Kinda like rent things

# Composition = The cpposed obejct directly owns its components, which cannot exist independently
#               "owns-a" relationship
# Kinda like own things
...
class Car:
    def __init__(self, make, model, horse_power, wheel_size):
        ...
        # self.wheels = Wheel(wheel_size) - one wheel, but cars dont have one wheel
